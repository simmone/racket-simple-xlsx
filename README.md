...
```
datasheet:
![ScreenShot](simple-xlsx/example/datasheet.png)

datasheetWithStyle:
![ScreenShot](simple-xlsx/example/datasheetWithStyle.png)

datasheetWithStyle2:
![ScreenShot](simple-xlsx/example/datasheetWithStyle2.png)

linechart:
![ScreenShot](simple-xlsx/example/linechart.png)

lintchart3d:
![ScreenShot](simple-xlsx/example/linechart3d.png)

barchart:
![ScreenShot](simple-xlsx/example/barchart.png)

barchart3d:
![ScreenShot](simple-xlsx/example/barchart3d.png)

piechart:
![ScreenShot](simple-xlsx/example/piechart.png)

piechart3d:
![ScreenShot](simple-xlsx/example/piechart3d.png)
