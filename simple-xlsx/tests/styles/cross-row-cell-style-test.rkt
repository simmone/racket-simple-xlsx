   ...
   (test-case
    ...
    (parameterize 
     ...
     (let (
       ...
       (check-equal? (hash-ref style_index->hash_map 2) (make-hash '((fontSize . 21))))
       (check-equal? (hash-ref style_index->hash_map 3) (make-hash '((fontSize . 21) (fontName . "Impact"))))
       ...
       (check-equal? (hash-ref font_style_index->hash_map 2) (make-hash '((fontSize . 21))))
       (check-equal? (hash-ref font_style_index->hash_map 3) (make-hash '((fontSize . 21) (fontName . "Impact"))))
       )
     ...
     (with-sheet
      ...
      (lambda ()
        (let (
          ...
          (check-equal? (hash-ref row->style_index_map 4) 2)
          ...
          (check-equal? (hash-ref cell->style_index_map "A2") 3)
          (check-equal? (hash-ref cell->style_index_map "B2") 3)
          (check-equal? (hash-ref cell->style_index_map "C2") 3)
          (check-equal? (hash-ref cell->style_index_map "A3") 3)
          (check-equal? (hash-ref cell->style_index_map "B3") 3)
          (check-equal? (hash-ref cell->style_index_map "C3") 3)
          )))
     ))
   ))
