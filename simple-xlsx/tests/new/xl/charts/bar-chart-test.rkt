  ...
  (test-suite
   ...
   (test-case
    ...
    (let ([xlsx (new xlsx%)])
      ...
      (send xlsx add-chart-sheet #:sheet_name "Chart1" #:chart_type 'bar #:topic "测试图表" #:x_topic "金额")
      ...
      (check-equal? (print-bar-chart "Chart1" xlsx) (chart-data))
    ))
