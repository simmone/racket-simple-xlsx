  ...
  (test-suite
   ...
   (test-case
    ...
    (let ([xlsx (new xlsx%)])
      ...
      (send xlsx add-chart-sheet #:sheet_name "Chart1" #:chart_type 'pie #:topic "测试图表" #:x_topic "金额")
      ...
      (check-equal? (print-pie-chart "Chart1" xlsx) (chart-data))
    ))
