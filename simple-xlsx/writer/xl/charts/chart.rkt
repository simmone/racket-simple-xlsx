  ...
  (with-output-to-string
    (lambda ()
      (let* ([chart_sheet (sheet-content (send xlsx get-sheet-by-name chart_sheet_name))]
        ...
        (printf "<c:chartSpace xmlns:c=\"http://schemas.openxmlformats.org/drawingml/2006/chart\" xmlns:a=\"http://schemas.openxmlformats.org/drawingml/2006/main\" xmlns:r=\"http://schemas.openxmlformats.org/officeDocument/2006/relationships\"><c:lang val=\"zh-CN\"/><c:chart><c:plotArea><c:layout/><c:lineChart><c:grouping val=\"standard\"/><c:title><c:tx><c:rich><a:bodyPr/><a:lstStyle/><a:p><a:pPr><a:defRPr/></a:pPr><a:r><a:rPr lang=\"zh-CN\" altLang=\"en-US\"/><a:t>~a</a:t></a:r></a:p></c:rich></c:tx></c:title>" topic)
